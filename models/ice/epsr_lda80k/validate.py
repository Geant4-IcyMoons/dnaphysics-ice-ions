...
from models.ice.epsr_lda80k.model import (  # noqa: E402
    EpsrAtoStructure,
    file_sha256,
    parse_ato,
    write_extended_xyz,
)
from physics.elastic.bca.structure import iter_xyz_frames  # noqa: E402
from models.ice.structure_checks import chill_plus  # noqa: E402
...
def _software_record(workers: int) -> dict[str, Any]:
    ...
    implementation_paths = (
        ...
        repository / "models/ice/structure_checks.py",
    )
