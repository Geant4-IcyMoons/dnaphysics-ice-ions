...
implemented by `python_scripts/physics_ice/nep_mbpol/prepare_hexagonal_ice_experimental_cell.py`,
`python_scripts/physics_ice/nep_mbpol/inputs/hexagonal_ih_100K_experimental_density.in`,
and `pbs/run_nep_mbpol_hexagonal.pbs`.
...
`python_scripts/physics_ice/process_evidence/ice_structures/validation/HEXAGONAL_ICE.md`.
Across
all 30 sampling frames, CHILL+
...
The proton-disordered inputs were produced with GenIce2 following Matsumoto,
Yagasaki, and Tanaka, *J. Comput. Chem.* **39**, 61--64 (2018),
<https://doi.org/10.1002/jcc.25077>. The lattice dynamics use the NEP-MB-pol
model of Xu et al., *npj Comput. Mater.* **11**, 279 (2025),
<https://doi.org/10.1038/s41524-025-01777-1>, distributed as the pinned model
artifact <https://doi.org/10.5281/zenodo.15033656>. The accepted XYZ archives
are production inputs; files under `../preparation/` are unequilibrated source
material and are diagnostic only.
