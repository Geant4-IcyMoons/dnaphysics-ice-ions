...
python physics/inelastic_dielectric/projectile_potentials/generate_projectile_atomic_data.py --workers 10
python -m pytest -q tests/test_projectile_form_factors.py
python physics/inelastic_dielectric/projectile_potentials/benchmarking/benchmark_projectile_form_factors.py --workers 10
```
...
`physics/inelastic_dielectric/projectile_potentials/benchmarking/plots/form_factors/`. Tests additionally check table
