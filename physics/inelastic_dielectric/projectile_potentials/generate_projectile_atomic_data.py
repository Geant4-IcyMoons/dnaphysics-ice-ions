...
See README.md for the approximation and benchmark protocol.
"""
...
from physics.inelastic_dielectric.projectile_potentials.projectile_form_factors import DATA_PATH, DEFAULT_WORKERS, ELEMENTS, VERSION, ProjectileDensity
