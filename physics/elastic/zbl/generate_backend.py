...
from physics.elastic.bca.structure import file_sha256, load_ice_structure  # noqa: E402
from physics.elastic.bca.trajectory import PeriodicHardCollisionTransport  # noqa: E402


REPOSITORY_ROOT = Path(__file__).resolve().parents[3]
ICE_STRUCTURES_ROOT = REPOSITORY_ROOT / "models/ice"
PHASE_REGISTRIES = {
    "hexagonal_ih_100k": (
        ICE_STRUCTURES_ROOT
