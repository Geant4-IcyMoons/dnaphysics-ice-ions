...
`example_4` is the amorphous-ice W-value Geant4-IcyMoons example.
...
- macro: [`example_4.mac`](example_4.mac)
- runner: [`run_example_4.sh`](run_example_4.sh)
- plotter: [`plot_example_4_wvalue.py`](plot_example_4_wvalue.py)
...
For `DNA_PHYSICS=ice_am`, the current ice workflow applies the amorphous-ice nominal density automatically while keeping the Geant4 material name as `G4_WATER`.
...
```bash
./Geant4_icyMoons_examples/example_4/run_example_4.sh \
...
- sets `DNA_PHYSICS=ice_am`
- sets `DNA_ROOT_BASENAME=example_4`
- sets `DNA_WVALUE_FILE` to the requested text filename
- sets `DNA_NTUPLE_FILES=0`
- launches `dnaphysics` on [`example_4.mac`](example_4.mac)

Expected outputs:

- `outputs/example_4.root`
- `outputs/example_4_wvalue.txt`
...
```bash
python3 Geant4_icyMoons_examples/example_4/plot_example_4_wvalue.py
```
...
```bash
python3 Geant4_icyMoons_examples/example_4/plot_example_4_wvalue.py \
  --txt "Geant4_icyMoons_examples/example_4/outputs/example_4_wvalue.txt" \
  --out "Geant4_icyMoons_examples/example_4/outputs/example_4_wvalue.png"
```
