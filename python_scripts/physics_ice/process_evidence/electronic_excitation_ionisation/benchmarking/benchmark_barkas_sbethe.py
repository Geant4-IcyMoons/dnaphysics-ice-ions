...
import barkas_dcs  # noqa: E402
import emfietzoglou_model_finite_q as model  # noqa: E402
...
DEFAULT_OUT_DIR = HERE / "runs" / "sbethe_v2"
...
def main(argv=None):
    ...
    work_dir = args.work_dir if args.work_dir is not None else out_dir / "_sbethe_work"
    ...
    plot_path = out_dir / "barkas_sbethe_benchmark_proton.png"
