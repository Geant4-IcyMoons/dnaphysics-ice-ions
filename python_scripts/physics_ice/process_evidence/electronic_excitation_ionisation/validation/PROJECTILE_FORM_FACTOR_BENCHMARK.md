...
[PROJECTILE_FORM_FACTORS.md](../../../PROJECTILE_FORM_FACTORS.md).
...
`plots/diagnostics/projectile_form_factors/benchmark.json` and
`projectile_form_factors.png`/`.pdf` in that same directory. These generated
...
python -m pytest -q tests/test_projectile_form_factors.py \
  ...
  tests/test_ion_optical_normalization.py tests/test_ice_phase_density.py \
