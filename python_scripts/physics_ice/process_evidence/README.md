...
| Soft nuclear collisions | failed charge-resolved work in `../nep_mbpol/soft_dft/`; diagnostic full-ZBL reference in `soft_nuclear_collisions/zbl/`; Geant4 runtime in `../../../include/G4DNAZBLFullElastic.hh` and `../../../src/G4DNAZBLFullElastic.cc` | `soft_nuclear_collisions/` |
