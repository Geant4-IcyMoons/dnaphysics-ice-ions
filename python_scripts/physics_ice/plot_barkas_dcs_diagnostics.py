...
from constants import CROSS_SECTION_PLOTS_DIR, PROJECTILE_LIBRARY, RC_BASE_ELASTIC, rcparams_with_fontsize


DEFAULT_OUT_DIR = CROSS_SECTION_PLOTS_DIR / "barkas_check"
