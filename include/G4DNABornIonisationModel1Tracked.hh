...
#ifndef G4DNABornIonisationModel1Tracked_h
#define G4DNABornIonisationModel1Tracked_h 1
...
class G4DNABornIonisationModel1Tracked : public G4VEmModel
{

public:

  G4DNABornIonisationModel1Tracked(const G4ParticleDefinition* p = nullptr,
		           const G4String& nam = "DNABornIonisationModel");

  ~G4DNABornIonisationModel1Tracked() override;
   
  G4DNABornIonisationModel1Tracked & operator=(const  G4DNABornIonisationModel1Tracked &right) = delete;
  G4DNABornIonisationModel1Tracked(const  G4DNABornIonisationModel1Tracked&) = delete;
...
inline void G4DNABornIonisationModel1Tracked::SelectFasterComputation (G4bool input)
{ 
    fasterCode = input; 
}		 
...
inline void G4DNABornIonisationModel1Tracked::SelectStationary (G4bool input)
{ 
    statCode = input; 
}		 
...
inline void G4DNABornIonisationModel1Tracked::SelectSPScaling (G4bool input)
{ 
    spScaling = input; 
}		 
