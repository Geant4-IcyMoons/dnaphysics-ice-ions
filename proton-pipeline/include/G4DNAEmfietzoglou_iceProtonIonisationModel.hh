...
public:
  ...
  G4DNAEmfietzoglou_iceProtonIonisationModel(const G4ParticleDefinition* p = nullptr,
                                   const G4String& nam =
                                       "DNAEmfietzoglou_iceProtonIonisationModel");

  ~G4DNAEmfietzoglou_iceProtonIonisationModel() override;

  G4DNAEmfietzoglou_iceProtonIonisationModel & operator=(const G4DNAEmfietzoglou_iceProtonIonisationModel &right) = delete;
  G4DNAEmfietzoglou_iceProtonIonisationModel(const G4DNAEmfietzoglou_iceProtonIonisationModel&) = delete;
...
private:
  ...
  G4DNAEmfietzoglou_iceProtonIonisationStructure waterStructure;
...
inline void G4DNAEmfietzoglou_iceProtonIonisationModel::SelectFasterComputation(G4bool input)
{
  fasterCode = input;
}
...
inline void G4DNAEmfietzoglou_iceProtonIonisationModel::SelectStationary (G4bool input)
{ 
    statCode = input; 
}		 
