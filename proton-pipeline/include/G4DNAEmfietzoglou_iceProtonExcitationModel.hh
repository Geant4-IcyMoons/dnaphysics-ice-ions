...
public:
  ...
  G4DNAEmfietzoglou_iceProtonExcitationModel(const G4ParticleDefinition* p = nullptr,
                                   const G4String& nam =
                                       "DNAEmfietzoglou_iceProtonExcitationModel");

  ~G4DNAEmfietzoglou_iceProtonExcitationModel() override;

  G4DNAEmfietzoglou_iceProtonExcitationModel & operator=(const G4DNAEmfietzoglou_iceProtonExcitationModel &right) = delete;
  G4DNAEmfietzoglou_iceProtonExcitationModel(const G4DNAEmfietzoglou_iceProtonExcitationModel&) = delete;
...
inline void G4DNAEmfietzoglou_iceProtonExcitationModel::SelectStationary (G4bool input)
{ 
    statCode = input; 
}		 
