...
G4DNAEmfietzoglou_iceProtonIonisationStructure::G4DNAEmfietzoglou_iceProtonIonisationStructure() 
{
  ...
  energyConstant.push_back(540.*eV);
...
G4double G4DNAEmfietzoglou_iceProtonIonisationStructure::IonisationEnergy(G4int level)
{
