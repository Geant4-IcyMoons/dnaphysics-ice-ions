...
G4DNAEmfietzoglou_iceProtonIonisationModel::G4DNAEmfietzoglou_iceProtonIonisationModel(const G4ParticleDefinition*,
                                                                   const G4String& nam) :
G4VEmModel(nam) 
{
  verboseLevel = 0;
...
G4DNAEmfietzoglou_iceProtonIonisationModel::~G4DNAEmfietzoglou_iceProtonIonisationModel()
{
  // Cross section
...
void G4DNAEmfietzoglou_iceProtonIonisationModel::Initialise(const G4ParticleDefinition* particle,
                                                  const G4DataVector& /*cuts*/)
{

  if(verboseLevel > 3)
  {
    G4cout << "Calling G4DNAEmfietzoglou_iceProtonIonisationModel::Initialise()" << G4endl;
  }
  ...
  G4String fileProton("dna/sigma_ionisation_p_emfietzoglou");
  ...
  std::string defaultDiffFile = fasterCode
      ? "sigmadiff_cumulated_ionisation_p_emfietzoglou.dat"
      : "sigmadiff_ionisation_p_emfietzoglou.dat";
  ...
  if (!icePhase.empty()) {
    const std::string phaseTotalFile =
        "sigma_ionisation_p_" + icePhase + "_ice_emfietzoglou_kyriakou";
    const std::string phaseDiffFile = fasterCode
        ? "sigmadiff_cumulated_ionisation_p_" + icePhase + "_ice_emfietzoglou_kyriakou.dat"
        : "sigmadiff_ionisation_p_" + icePhase + "_ice_emfietzoglou_kyriakou.dat";
  ...
  std::ifstream pDiffCrossSection(diffPath.c_str());

  if (!pDiffCrossSection)
  {
    const std::string missing = "Missing data file: " + diffPath;
    if (fasterCode) G4Exception("G4DNAEmfietzoglou_iceProtonIonisationModel::Initialise","em0003",
  ...
  while(!pDiffCrossSection.eof())
  {
    ...
    for (G4int j=0; j<5; j++)
    {
      pDiffCrossSection>>eDiffCrossSectionData[j][tDummy][eDummy];
...
G4double G4DNAEmfietzoglou_iceProtonIonisationModel::
                      ...
                      G4double)
{
  ...
  {
    G4cout
        << "Calling CrossSectionPerVolume() of G4DNAEmfietzoglou_iceProtonIonisationModel"
        << G4endl;
  }
  ...
  if (ekin >= LowEnergyLimit() && ekin <= HighEnergyLimit())
  {
    ...
    {
      G4Exception("G4DNAEmfietzoglou_iceProtonIonisationModel::CrossSectionPerVolume","em0002",
  ...
  if (verboseLevel > 2)
  {
    ...
    G4cout << "G4DNAEmfietzoglou_iceProtonIonisationModel - XS INFO START" << G4endl;
    G4cout << "Kinetic energy(eV)=" << ekin/eV << " particle : " << particleName << G4endl;
    G4cout << "Cross section per water molecule (cm^2)=" << sigma/cm/cm << G4endl;
    G4cout << "Cross section per water molecule (cm^-1)=" << sigma*waterDensity/(1./cm) << G4endl;
    G4cout << "G4DNAEmfietzoglou_iceProtonIonisationModel - XS INFO END" << G4endl;
  }
...
void G4DNAEmfietzoglou_iceProtonIonisationModel::
                  ...
                  G4double)
{
  ...
  if(verboseLevel > 3)
  {
    G4cout << "Calling SampleSecondaries() of G4DNAEmfietzoglou_iceProtonIonisationModel"
           << G4endl;
  }
                               ...
                               G4int shell)
{
  ...
  {
    const G4double bindingEnergy = waterStructure.IonisationEnergy(shell);
    const G4double maxSecondaryKinetic = 4.0 * (electron_mass_c2 / proton_mass_c2) * k;
    const G4double maximumEnergyTransfer = bindingEnergy + maxSecondaryKinetic;
    if (maximumEnergyTransfer <= bindingEnergy) {
      return 0.0;
    }
    ...
    */
    ...
    G4double minEnergy = bindingEnergy;
    ...
    do
    {
      secondaryElectronKineticEnergy = G4UniformRand() * (maximumEnergyTransfer - bindingEnergy);
    }while(G4UniformRand()*crossSectionMaximum >
        DifferentialCrossSection(particleDefinition, k/eV,
            (secondaryElectronKineticEnergy + bindingEnergy) / eV, shell));
...
/*
 void G4DNAEmfietzoglou_iceProtonIonisationModel::RandomizeEjectedElectronDirection(G4ParticleDefinition* particleDefinition,
 G4double k,
 G4double secKinetic,
 G4double & cosTheta,
 G4double & phi )
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double G4DNAEmfietzoglou_iceProtonIonisationModel::DifferentialCrossSection(G4ParticleDefinition * particleDefinition,
                                                                  G4double k,
...
G4double G4DNAEmfietzoglou_iceProtonIonisationModel::Interpolate(G4double e1,
                                                       G4double e2,
                                                       G4double e,
                                                       G4double xs1,
                                                       G4double xs2)
...
G4double G4DNAEmfietzoglou_iceProtonIonisationModel::QuadInterpolator(G4double e11,
                                                            G4double e12,
                                                            G4double e21,
                                                            G4double e22,
                                                            G4double xs11,
...
G4int G4DNAEmfietzoglou_iceProtonIonisationModel::RandomSelect(G4double k,
                                                     const G4String& particle)
{
  ...
  {
    G4Exception("G4DNAEmfietzoglou_iceProtonIonisationModel::RandomSelect",
                "em0002",
                FatalException,
...
G4double G4DNAEmfietzoglou_iceProtonIonisationModel::RandomizeEjectedElectronEnergyFromCumulatedDcs(G4ParticleDefinition* particleDefinition,
                                                                                          G4double k,
                                                                                          G4int shell)
{
...
G4double G4DNAEmfietzoglou_iceProtonIonisationModel::RandomTransferedEnergy(G4ParticleDefinition* particleDefinition,
                                                                  G4double k,
                                                                  G4int ionizationLevelIndex)
{
