...
{
  return g_lastBornExcLevelTracked;
}
...
G4DNABornExcitationModel1Tracked::~G4DNABornExcitationModel1Tracked()
{
  // Cross section
...
void G4DNABornExcitationModel1Tracked::Initialise(const G4ParticleDefinition* particle,
                                           const G4DataVector& /*cuts*/)
{

  if (verboseLevel > 3)
  {
    G4cout << "Calling G4DNABornExcitationModel1Tracked::Initialise()" << G4endl;
  }

  if(fParticleDefinition != nullptr && fParticleDefinition != particle)
  {
    G4Exception("G4DNABornExcitationModel1Tracked::Initialise","em0001",
...
G4double G4DNABornExcitationModel1Tracked::CrossSectionPerVolume(const G4Material* material,
                                                          ...
                                                          G4double)
{
  if (verboseLevel > 3)
  {
    G4cout << "Calling CrossSectionPerVolume() of G4DNABornExcitationModel1Tracked"
        << G4endl;
  }
  ...
  if (verboseLevel > 2)
  {
    ...
    G4cout << "G4DNABornExcitationModel1Tracked - XS INFO START" << G4endl;
    G4cout << "Kinetic energy(eV)=" << ekin/eV << " particle : " << particleDefinition->GetParticleName() << G4endl;
    G4cout << "Cross section per water molecule (cm^2)=" << sigma/cm/cm << G4endl;
    G4cout << "Cross section per water molecule (cm^-1)=" << sigma*waterDensity/(1./cm) << G4endl;
    G4cout << "G4DNABornExcitationModel1Tracked - XS INFO END" << G4endl;
  }
...
void G4DNABornExcitationModel1Tracked::SampleSecondaries(std::vector<G4DynamicParticle*>* /*fvect*/,
                                                  ...
                                                  G4double)
{
  ...
  if (verboseLevel > 3)
  {
    G4cout << "Calling SampleSecondaries() of G4DNABornExcitationModel1Tracked"
        << G4endl;
  }
  ...
  g_lastBornExcLevelTracked = level;
...
G4double G4DNABornExcitationModel1Tracked::GetPartialCrossSection(const G4Material*,
                                                           G4int level,
                                                           ...
                                                           G4double kineticEnergy)
{
  ...
  {
    G4Exception("G4DNABornExcitationModel1Tracked::GetPartialCrossSection",
                "bornParticleType",
                FatalException,
