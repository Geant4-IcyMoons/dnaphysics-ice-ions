...
{
  return g_lastBornIonShellTracked;
}
...
G4DNABornIonisationModel1Tracked::~G4DNABornIonisationModel1Tracked()
{
  // Cross section
...
void G4DNABornIonisationModel1Tracked::Initialise(const G4ParticleDefinition* particle,
                                           const G4DataVector& /*cuts*/)
{

  if (verboseLevel > 3)
  {
    G4cout << "Calling G4DNABornIonisationModel1Tracked::Initialise()" << G4endl;
  }
  ...
  {
    if (fasterCode) G4Exception("G4DNABornIonisationModel1Tracked::Initialise","em0003",
...
G4double G4DNABornIonisationModel1Tracked::CrossSectionPerVolume(const G4Material* material,
                                                          ...
                                                          G4double)
{
  if (verboseLevel > 3)
  {
    G4cout << "Calling CrossSectionPerVolume() of G4DNABornIonisationModel1Tracked"
        << G4endl;
  }
  ...
  if (ekin >= lowLim && ekin <= highLim)
  {
    ...
    {
      G4Exception("G4DNABornIonisationModel1Tracked::CrossSectionPerVolume","em0002",
  ...
  if (verboseLevel > 2)
  {
    ...
    G4cout << "G4DNABornIonisationModel1Tracked - XS INFO START" << G4endl;
    G4cout << "Kinetic energy(eV)=" << ekin/eV << " particle : " << particleName << G4endl;
    G4cout << "Cross section per water molecule (cm^2)=" << sigma/cm/cm << G4endl;
    G4cout << "Cross section per water molecule (cm^-1)=" << sigma*waterDensity/(1./cm) << G4endl;
    G4cout << "G4DNABornIonisationModel1Tracked - XS INFO END" << G4endl;
  }
...
void G4DNABornIonisationModel1Tracked::SampleSecondaries(std::vector<G4DynamicParticle*>* fvect,
                                                  ...
                                                  G4double)
{
  ...
  if (verboseLevel > 3)
  {
    G4cout << "Calling SampleSecondaries() of G4DNABornIonisationModel1Tracked"
        << G4endl;
  }
  ...
  if (k >= lowLim && k <= highLim)
  {
    ...
    g_lastBornIonShellTracked = ionizationShell;
...
G4double G4DNABornIonisationModel1Tracked::RandomizeEjectedElectronEnergy(G4ParticleDefinition* particleDefinition,
                                                                   G4double k,
                                                                   G4int shell)
{
...
/*
 void G4DNABornIonisationModel1Tracked::RandomizeEjectedElectronDirection(G4ParticleDefinition* particleDefinition,
 G4double k,
 G4double secKinetic,
 G4double & cosTheta,
 G4double & phi )
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double G4DNABornIonisationModel1Tracked::DifferentialCrossSection(G4ParticleDefinition * particleDefinition,
                                                           G4double k,
                                                           ...
                                                           G4int ionizationLevelIndex)
{
  ...
  if (energyTransfer >= waterStructure.IonisationEnergy(ionizationLevelIndex)/eV)
  {
    ...
    if (particleDefinition == G4Proton::ProtonDefinition())
    {
      ...
      // k should be in eV and energy transfer eV also
      auto t2 = std::upper_bound(pTdummyVec.begin(),
                                                          pTdummyVec.end(),
                                                          k);
      auto t1 = t2 - 1;

      auto e12 = std::upper_bound(pVecm[(*t1)].begin(),
                                                           pVecm[(*t1)].end(),
                                                           energyTransfer);
      auto e11 = e12 - 1;

      auto e22 = std::upper_bound(pVecm[(*t2)].begin(),
                                                           pVecm[(*t2)].end(),
                                                           energyTransfer);
      auto e21 = e22 - 1;
...
G4double G4DNABornIonisationModel1Tracked::Interpolate(G4double e1,
                                                G4double e2,
                                                G4double e,
                                                G4double xs1,
                                                G4double xs2)
...
G4double G4DNABornIonisationModel1Tracked::QuadInterpolator(G4double e11,
                                                     G4double e12,
                                                     G4double e21,
                                                     G4double e22,
                                                     G4double xs11,
...
G4double G4DNABornIonisationModel1Tracked::GetPartialCrossSection(const G4Material* /*material*/,
                                                           G4int level,
...
G4int G4DNABornIonisationModel1Tracked::RandomSelect(G4double k,
                                              const G4String& particle)
{
  ...
  {
    G4Exception("G4DNABornIonisationModel1Tracked::RandomSelect",
                "em0002",
                FatalException,
...
G4double G4DNABornIonisationModel1Tracked::RandomizeEjectedElectronEnergyFromCumulatedDcs(G4ParticleDefinition* particleDefinition,
                                                                                   G4double k,
                                                                                   G4int shell)
{
...
G4double G4DNABornIonisationModel1Tracked::TransferedEnergy(G4ParticleDefinition* particleDefinition,
                                                     G4double k,
                                                     G4int ionizationLevelIndex,
                                                     G4double random)
{
